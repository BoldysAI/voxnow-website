...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="pt-32 pb-24 px-4 bg-gradient-to-br from-blue-50/50 via-white to-green-50/30 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Trust indicators - Small lawyer photos */}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => {
                trackCustomEvent('DiscoverSolutionClick', {
                  content_name: 'Discover Solution from Trusted Lawyers',
                  content_category: 'Lead Generation'
                });
                navigate('/dashboard');
              }}
              className="bg-gradient-to-r from-vox-blue to-now-green text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
      ...
      <section id="video-testimonial" className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-gray-200 px-6 py-3 rounded-full shadow-sm mb-6">
              <MessageCircle className="h-5 w-5 text-vox-blue mr-2" />
              <span className="text-vox-blue font-medium">Témoignage client</span>
            </div>
            
            <h2 className="text-3xl md:text-4xl font-bold gradient-text mb-6">
              L'avis de Maître Bastien Lombaerd
            </h2>
            
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Découvrez comment VoxNow transforme la gestion quotidienne des messages vocaux 
              dans le cabinet de Maître Lombaerd, avocat au barreau de Bruxelles.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-2 order-2 lg:order-1">
                <div className="relative">
                  <div className="bg-gradient-to-br from-vox-blue/10 to-now-green/10 rounded-3xl p-6">
                    <iframe
                      src="https://player.cloudinary.com/embed/?cloud_name=drdqov4zs&public_id=te%CC%81moignage_bastien_ljtucj&profile=cld-default"
                      width="300"
                      height="500"
                      style={{ height: '500px', width: '100%', maxWidth: '300px', margin: '0 auto', display: 'block' }}
              ...
              <div className="lg:col-span-3 order-1 lg:order-2">
                <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                  <div className="flex items-center space-x-6 mb-8">
                    ...
                    />
                    <div>
                      <p className="font-bold text-vox-blue text-xl">Bastien Lombaerd</p>
                      <p className="text-gray-600 text-lg">Avocat au barreau de Bruxelles</p>
                      <div className="flex items-center space-x-4 mt-2">
                        <a
                          ...
                          onClick={() => trackCustomEvent('VideoTestimonialLinkedInClick', { 
                            author: 'Bastien Lombaerd' 
                          })}
                        >
                        ...
                        <a
                          ...
                          className="text-gray-400 hover:text-vox-blue transition-colors"
                          onClick={() => trackCustomEvent('VideoTestimonialEmailClick', { 
                            author: 'Bastien Lombaerd' 
                          })}
                        >
                  ...
                  <blockquote className="text-gray-700 leading-relaxed space-y-4">
                    <p className="text-lg italic font-medium text-vox-blue">
                      "VoxNow a complètement transformé ma façon de gérer les appels manqués."
                    </p>
                    
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-vox-blue rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Gain de temps :</strong> "Je gagne facilement 2 à 3 heures par jour. Plus besoin d'écouter chaque message - je reçois directement un résumé clair par email."</p>
                      </div>
                      
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-now-green rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Satisfaction client :</strong> "Mes clients adorent recevoir une confirmation automatique par SMS. Ils savent que leur demande a été prise en compte."</p>
                      </div>
                      
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-light-blue rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Priorisation :</strong> "L'analyse d'urgence me permet de traiter en priorité les dossiers qui le nécessitent vraiment."</p>
                      </div>
                      
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-light-green rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>Sécurité :</strong> "En tant qu'avocat, la confidentialité est cruciale. VoxNow respecte parfaitement nos obligations déontologiques."</p>
                      </div>
                    </div>
                    
                    <p className="text-lg italic font-medium text-now-green pt-4">
                      "Je recommande VoxNow à tous mes confrères. C'est un investissement qui se rentabilise dès le premier mois."
                    </p>
                  </blockquote>
                </div>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          {/* Scrolling Lawyers */}
          <div className="relative overflow-hidden">
            <div className="flex animate-scroll space-x-8" style={{ width: 'calc(200% + 2rem)' }}>
              {/* First set */}
              {[
                {
                  name: 'Gilles Rousseau',
                ...
                },
                {
                  name: 'Geoffroy Huez',
                  image: 'https://res.cloudinary.com/drdqov4zs/image/upload/v1754933288/Screenshot_2025-08-11_at_19.28.04_fqwjud.png',
                  linkedin: 'https://www.linkedin.com/in/geoffroy-huez-2589388a/',
                  email: 'mandathuez@gmail.com'
                },
                {
                  name: 'Thibault Delaey',
                  image: 'https://res.cloudinary.com/drdqov4zs/image/upload/v1754933487/Screenshot_2025-08-11_at_19.31.21_jxramd.png',
                  linkedin: 'https://www.linkedin.com/in/delaeythibault/',
                  email: 'ta.delaey@avocat.be'
                },
                {
                  name: 'Samuel Pochet',
                  image: 'https://res.cloudinary.com/drdqov4zs/image/upload/v1754934117/Screenshot_2025-08-11_at_19.41.51_bi7rn6.png',
                  linkedin: 'https://www.linkedin.com/in/samuel-pochet-a32ba476/',
                  email: 'samuel@pochet.eu'
                }
              ].concat([
                {
                  name: 'Gilles Rousseau',
                ...
                <div key={index} className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 flex-shrink-0 w-80">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Avocat au Barreau</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4 text-sm">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-vox-blue hover:text-now-green transition-colors font-medium"
                      onClick={() => trackCustomEvent('LawyerLinkedInClick', {
                        content_name: `${lawyer.name} LinkedIn`,
                        content_category: 'Social Proof'
                      })}
                    >
                      LinkedIn
                    ...
                    <a
                      ...
                      className="text-vox-blue hover:text-now-green transition-colors font-medium"
                      onClick={() => trackCustomEvent('LawyerEmailClick', {
                        content_name: `${lawyer.name} Email`,
                        content_category: 'Social Proof'
                      })}
                    >
                      Email
