...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-18 px-4 bg-gradient-to-br from-blue-50/50 via-white to-green-50/30 relative overflow-hidden">
      ...
      <section id="gain-section" className="pt-6 pb-6 px-4 bg-gradient-to-b from-white to-gray-50">
