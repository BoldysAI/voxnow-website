...
export function GravacaoPage() {
  useEffect(() => {
    window.scrollTo({ top: 0, behavior: 'smooth' });
    
    // Track recording page view
    trackViewContent({
      content_name: 'Gravacao Page',
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm border border-gray-200 px-6 py-3 rounded-full shadow-sm mb-6">
              ...
              <span className="text-gray-700 font-medium">Configuração do seu serviço VoxNow</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl font-bold gradient-text mb-6">
              Configure o seu atendimento telefónico
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Grave a mensagem de acolhimento que os seus clientes ouvirão quando lhe telefonarem. 
              Depois configuraremos o seu serviço VoxNow personalizado.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Configuração personalizada</h3>
                <p className="text-gray-600 text-sm">Analisamos as suas necessidades para configurar o serviço</p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Código de encaminhamento</h3>
                <p className="text-gray-600 text-sm">Receberá um código personalizado para ativar o serviço</p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Ativação rápida</h3>
                <p className="text-gray-600 text-sm">Serviço operacional em poucos minutos</p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <GravadorVoz onRecordingComplete={handleRecordingComplete} />
          </div>
          ...
          <div className="mt-16 bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Preencha</h3>
                <p className="text-gray-600 text-sm">Insira as suas informações de contacto</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Grave</h3>
                <p className="text-gray-600 text-sm">Deixe uma mensagem vocal para configurar o seu atendimento</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Configuramos</h3>
                <p className="text-gray-600 text-sm">A nossa equipa configura o seu serviço personalizado</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Ative</h3>
                <p className="text-gray-600 text-sm">Use o código recebido para ativar a sua linha</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-vox-blue to-now-green p-[1px] rounded-2xl">
              <div className="bg-white px-8 py-6 rounded-2xl">
                <h3 className="text-xl font-bold bg-gradient-to-r from-vox-blue to-now-green bg-clip-text text-transparent mb-4">
                  Precisa de ajuda para a configuração?
                </h3>
                <button
                  onClick={() => {
